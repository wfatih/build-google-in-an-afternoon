...
\pagestyle{fancy}
\fancyhf{}
\lhead{\small\textcolor{gray}{Mini-Google — Web Crawler \& Search Engine}}
...
% ── title ─────────────────────────────────────────────────────────────────────
\begin{center}
  {\LARGE\bfseries\color{accent} Mini-Google Quiz 1}\\[6pt]
...
\begin{tabular}{@{} l p{11cm}}
  \textbf{URL:} &
  \texttt{https://en.wikipedia.org/wiki/Python\_(programming\_language)} \\[4pt]
...
\begin{tabular}{lcc}
  \toprule
  & \textbf{Manual} & \textbf{API} \\
  \midrule
  \textbf{\#1 URL}   &
    \texttt{.../Python\_(programming\_language)} &
    \texttt{.../Python\_(programming\_language)} \\
  \textbf{Score} & 6420 & 6420 \\
  \bottomrule
\end{tabular}
\end{center}
